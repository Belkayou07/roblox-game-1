...
set "SCRIPT_DIR=%~dp0"
set "SCRIPT_PATH=%SCRIPT_DIR%create_anime_roblox_base_mannequin_v4.py"
set "BLENDER_EXE="

if not exist "%SCRIPT_PATH%" (
    echo [ERROR] The v4 Blender generator was not found:
    echo %SCRIPT_PATH%
    pause
    exit /b 1
)
...
echo %BLENDER_EXE%
echo.
echo Generating the v4 blank anime Roblox base mannequin...
...
echo.
echo [DONE] The v4 mannequin was generated successfully.
echo Output folder:
